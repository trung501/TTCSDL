...
namespace GUI
{
    public partial class LichSuGUI : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            dtpNgayTiem.Text = gridView1.GetRowCellValue(e.RowHandle, "NGAYTIEM").ToString().Split(' ')[0];
            ...
            dtpNhacLai.Text = gridView1.GetRowCellValue(e.RowHandle, "NGAYTIEMNHACLAI").ToString().Split(' ')[0];
