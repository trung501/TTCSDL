...
namespace DTO
{
    public class DTO_QuanLyVaccine
    {
        ...
        public DTO_QuanLyVaccine(string maVC, string tenVC, string nhaSX, string ngaySX, string hanSD, string soLo, int soLuongSan, int donGia, string maloaiVC, string maQuanKho)
        {
            this.maVC = maVC;
            this.tenVC = tenVC;
            this.nhaSX = nhaSX;
